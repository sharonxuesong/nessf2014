...
\begin{itemize}[leftmargin=2.2em]
  \vspace{-3pt}
\item Perform pilot studies for the upcoming new \hrs\ and project
  \minerva.
  \vspace{-3pt}
\end{itemize}
...
%---------------------------------------------------------------------------------------
\vspace{-3pt}
\subsection{Improving the RV Precision of Keck}\label{keck} 

Telluric lines.

Wavelength-dependent statistical weighting.


%---------------------------------------------------------------------------------------
\vspace{-3pt}
\subsection{Pilot Studies for the Upcoming New \hrs\ and Project Minerva}\label{het}

Iodine FTS validation.

Telluric lines.

Data reduction and IP analysis.
