...
\title{\vspace{-45pt} \bf \Large Finding the Lowest Mass Exoplanets with
  \\ Improved Radial Velocimetry: Progress Report 2015 \vspace{-15pt}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-48pt}
\section{Summary of Program and Orignal Plans}
\vspace{-5pt}
...
%    \includegraphics[scale=0.6]{telluric}
    \includegraphics[width=0.32\textwidth]{185144_RV_BC_rj172}
    \includegraphics[width=0.32\textwidth]{185144_RV_BC_rj172.tell_dsst_ftsh2o150.eps}
%    \includegraphics[width=0.32\textwidth]{185144_RV_BC_diff_rj172_10}
    \includegraphics[width=0.32\textwidth]{185144_RV_BC_diff_rj172}        
  \end{center}
  \vspace{-25pt}  
